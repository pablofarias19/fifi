# -*- coding: utf-8 -*-
"""
ANALYSER_SALUD - Analizador Jurídico-Sanitario con RAG + Gemini Pro
--------------------------------------------------------------------
- Bases RAG versionadas: Salud Médica, Salud Laboral, Jurisprudencia, Legislación
- LLM: Gemini 2.5 Pro
- Recuperación: Chroma con re-scoring jurídico-sanitario
- Entrada: PDF (con OCR) o texto/consulta
- Salida: Informe PDF + JSON

Uso CLI:
  python analyser_salud.py --pdf ./ejemplo.pdf --out reporte.pdf
